 ...
 */
class DataStoreRepositoriesPreferences @Inject constructor(
    @ApplicationContext private val context: Context
) : RepositoriesPreferences {
    companion object {
     ...
     */
    override val repositoriesFlow: Flow<List<Repository>> = context.dataStore.data
        .map { preferences ->
    ...
    override val selectedRepoFlow: Flow<String?> =
        context.dataStore.data.map { it[SELECTED_REPO_KEY] }
    override val selectedBranchFlow: Flow<String?> =
        context.dataStore.data.map { it[SELECTED_BRANCH_KEY] }
